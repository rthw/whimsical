document.addEventListener("DOMContentLoaded", () => {
  ...
  editor.BlockManager.add("div-block", {
    ...
    category: "Basic",
    content:
      '<div style="padding: 20px; min-height: 100px; background-color: #f1f1f1;">This is a div block</div>',
    media:
      '<svg viewBox="0 0 24 24"><rect width="100%" height="100%" fill="#3b97e3"/></svg>',
  });
  ...
  editor.BlockManager.add("section-block", {
    ...
    category: "Basic",
    content:
      '<section style="padding: 50px 0; background-color: #ffffff;"><div style="max-width: 1200px; margin: 0 auto; padding: 0 15px;"></div></section>',
    media:
      '<svg viewBox="0 0 24 24"><rect width="100%" height="100%" fill="#4CAF50"/></svg>',
  });
  ...
  editor.BlockManager.add("text-block", {
    ...
    media:
      '<svg viewBox="0 0 24 24"><text x="50%" y="60%" text-anchor="middle" font-size="14">T</text></svg>',
  });
  ...
  editor.BlockManager.add("paragraph-block", {
    ...
    media:
      '<svg viewBox="0 0 24 24"><text x="50%" y="60%" text-anchor="middle" font-size="14">¶</text></svg>',
  });
  ...
  editor.BlockManager.add("list-block", {
    ...
    media:
      '<svg viewBox="0 0 24 24"><text x="30%" y="60%" text-anchor="start" font-size="12">• • •</text></svg>',
  });
  ...
  blocksContainer.style.cssText =
    "position: absolute; top: 0; right: 0; width: 250px; height: 100%; overflow-y: auto; background-color: #f5f5f5; padding: 10px; border-left: 1px solid #ddd;";
      ...
      input.onchange = (e) => {
        ...
        reader.onload = function () {
          try {
            ...
            editor.Notifications.error(
              "Error importing project: Invalid file format",
            );
          }
        };
